...
<div id='top_body'  class='  clearfix' >
												...
												<div class='one_third_column'  >
													...
													<div  class=' rounded_bg' >
													  ...
													  <div class="middle">
																...
																<div id='logo' >
																	<img src='<?php  echo base_url()   ?>images//scenecredit2.png' />
																...
																<div  class='wrapper '   style='margin:0px 0px 0px 30px;'  >	
																		...
																		<div id='box_inside_header' class=' header_style' >
																									Sign Up	<span  class='or_redirect ' >&nbsp;(or <a href='<?php  echo base_url()   ?>index.php/home/login'>Log In</a>)</span>	
																		</div>
				...
				<div   id='confirm_wrapper'  class=' input_wrapper'>
							<div  class='input_label_header' >
								Confirm
							</div>
							<div  class='input_background input_250 ' >
