<div  id='working_area_wrapper'>
		...
		Basic Templates - Horizontal Scrolling
		</div>
		<div  class=' label_description add_more_margin_on_left' >
				<?php
				 	$this->load->view('main/views/sections/middle_section/middle_section_left/menu/template/template_bottom/basic_menu/description.php');  
				?>
		</div>
